...
public abstract class BlurredBackgroundDrawable extends Drawable {
    ...
    public static void drawStroke(
        ...
        if (!NyaConfig.INSTANCE.getStrokeOnViews().Bool()) return;
    ...
    private void drawSourceColorImpl(Canvas canvas, int sourceColor) {
        ...
        final NinePatchDrawable ninePatchDrawable = checkNinePatchDrawable(fillColor, NyaConfig.INSTANCE.getStrokeOnViews().Bool());
