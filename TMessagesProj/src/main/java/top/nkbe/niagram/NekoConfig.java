...
import static top.nkbe.niagram.config.ConfigItem.configTypeBool;
import static top.nkbe.niagram.config.ConfigItem.configTypeFloat;
import static top.nkbe.niagram.config.ConfigItem.configTypeInt;
import static top.nkbe.niagram.config.ConfigItem.configTypeLong;
import static top.nkbe.niagram.config.ConfigItem.configTypeMapIntInt;
import static top.nkbe.niagram.config.ConfigItem.configTypeSetInt;
import static top.nkbe.niagram.config.ConfigItem.configTypeString;
...
public class NekoConfig {
    ...
    public static ConfigItem customSavePath = addConfig("customSavePath", configTypeString, "Niagram");
