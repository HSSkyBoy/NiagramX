package top.nkbe.niagram.ui.components;
...
public final class InputTextAnimation implements TextWatcher {
    ...
    private float strength() {
        switch (Math.max(0, Math.min(4, NyaConfig.INSTANCE.getInputAnimationStrength().Int()))) {
            case 0: return .35f;
            case 1: return .65f;
            case 3: return 1.5f;
            case 4: return 2f;
    ...
    private boolean enabled(CharSequence text) {
        return NyaConfig.INSTANCE.getInputTextAnimations().Bool()
